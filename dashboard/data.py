"""Carregamento e preparação de dados, compartilhados por todas as páginas.

Mantém a lógica de agregação em um único lugar — cada página importa só o que
precisa, evitando recálculo divergente do mesmo número em telas diferentes.
"""
...
def linear_trend(x: pd.Series, y: pd.Series) -> tuple[np.ndarray, np.ndarray]:
    """Reta de regressão simples (numpy), sem dependência de statsmodels."""
